...
export function Resume() {
  // Resume details
  const resumeDetails = {
    title: "Farzad's Resume",
    description: 'Full Stack Developer • Aspiring AI/ML Engineer',
    fileType: 'PDF',
    lastUpdated: 'July 2025',
    fileSize: '0.5 MB',
    downloadUrl: '/FarzadResumeCS.pdf',
  };
  ...
  return (
    <div className="mx-auto w-full py-8 font-sans">
      <motion.div
        ...
        transition={{ duration: 0.0, ease: 'easeOut' as Easing}}
